...
export const downloadCSV = async (req, res, next) => {
    ...
    const yy = req.params.startDate;
    const mm = req.params.endDate;
    try {
        ...
        // const sql = `SELECT * FROM eventtable WHERE log_date BETWEEN '${startDate}' AND '${endDate}' ORDER BY meter_id ASC, log_date DESC, log_time DESC;`
        const sql = `SELECT * FROM table${yy}${mm} ORDER BY meter_id ASC, log_date DESC, log_time DESC;`
        console.log(sql)
